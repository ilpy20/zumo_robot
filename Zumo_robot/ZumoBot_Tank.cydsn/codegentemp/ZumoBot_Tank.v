...
// Timer_v2_80(CaptureAlternatingFall=false, CaptureAlternatingRise=false, CaptureCount=2, CaptureCounterEnabled=false, CaptureInputEnabled=true, CaptureMode=1, CONTROL3=1, ControlRegRemoved=0, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG16, CySetRegReplacementString=CY_SET_REG16, DeviceFamily=PSoC5, EnableMode=0, FF16=true, FF8=false, FixedFunction=true, FixedFunctionUsed=1, HWCaptureCounterEnabled=false, InterruptOnCapture=false, InterruptOnFIFOFull=false, InterruptOnTC=true, IntOnCapture=0, IntOnFIFOFull=0, IntOnTC=1, NumberOfCaptures=1, param45=1, Period=65535, RegDefReplacementString=reg16, RegSizeReplacementString=uint16, Resolution=16, RstStatusReplacementString=rstSts, RunMode=0, SiliconRevision=0, SoftwareCaptureModeEnabled=false, SoftwareTriggerModeEnabled=false, TriggerInputEnabled=false, TriggerMode=0, UDB16=false, UDB24=false, UDB32=false, UDB8=false, UDBControlReg=false, UsesHWEnable=0, VerilogSectionReplacementString=sT16, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=Timer_v2_80, CY_CONFIG_TITLE=Timer_R3, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Timer_R3, CY_INSTANCE_SHORT_NAME=Timer_R3, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=80, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=Timer_R3, )
...
// Timer_v2_80(CaptureAlternatingFall=false, CaptureAlternatingRise=false, CaptureCount=2, CaptureCounterEnabled=false, CaptureInputEnabled=true, CaptureMode=1, CONTROL3=1, ControlRegRemoved=0, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG16, CySetRegReplacementString=CY_SET_REG16, DeviceFamily=PSoC5, EnableMode=0, FF16=true, FF8=false, FixedFunction=true, FixedFunctionUsed=1, HWCaptureCounterEnabled=false, InterruptOnCapture=false, InterruptOnFIFOFull=false, InterruptOnTC=true, IntOnCapture=0, IntOnFIFOFull=0, IntOnTC=1, NumberOfCaptures=1, param45=1, Period=65535, RegDefReplacementString=reg16, RegSizeReplacementString=uint16, Resolution=16, RstStatusReplacementString=rstSts, RunMode=0, SiliconRevision=0, SoftwareCaptureModeEnabled=false, SoftwareTriggerModeEnabled=false, TriggerInputEnabled=false, TriggerMode=0, UDB16=false, UDB24=false, UDB32=false, UDB8=false, UDBControlReg=false, UsesHWEnable=0, VerilogSectionReplacementString=sT16, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=Timer_v2_80, CY_CONFIG_TITLE=Timer_R1, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Timer_R1, CY_INSTANCE_SHORT_NAME=Timer_R1, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=80, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=Timer_R1, )
...
// Timer_v2_80(CaptureAlternatingFall=false, CaptureAlternatingRise=false, CaptureCount=2, CaptureCounterEnabled=false, CaptureInputEnabled=true, CaptureMode=1, CONTROL3=1, ControlRegRemoved=0, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG16, CySetRegReplacementString=CY_SET_REG16, DeviceFamily=PSoC5, EnableMode=0, FF16=true, FF8=false, FixedFunction=true, FixedFunctionUsed=1, HWCaptureCounterEnabled=false, InterruptOnCapture=false, InterruptOnFIFOFull=false, InterruptOnTC=true, IntOnCapture=0, IntOnFIFOFull=0, IntOnTC=1, NumberOfCaptures=1, param45=1, Period=65535, RegDefReplacementString=reg16, RegSizeReplacementString=uint16, Resolution=16, RstStatusReplacementString=rstSts, RunMode=0, SiliconRevision=0, SoftwareCaptureModeEnabled=false, SoftwareTriggerModeEnabled=false, TriggerInputEnabled=false, TriggerMode=0, UDB16=false, UDB24=false, UDB32=false, UDB8=false, UDBControlReg=false, UsesHWEnable=0, VerilogSectionReplacementString=sT16, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=Timer_v2_80, CY_CONFIG_TITLE=Timer_L1, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Timer_L1, CY_INSTANCE_SHORT_NAME=Timer_L1, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=80, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=Timer_L1, )
...
// ADC_SAR_v3_10(ADC_Clock=1, ADC_Clock_Frequency=11368422, ADC_Input_Range=1, ADC_Power=0, ADC_Reference=1, ADC_Resolution=12, ADC_SampleMode=0, Enable_next_out=false, Ref_Voltage=2.5, Ref_Voltage_mV=2500, rm_int=false, Sample_Precharge=6, Sample_Rate=631579, Sample_Rate_def=631579, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=ADC_SAR_v3_10, CY_CONFIG_TITLE=ADC_Battery, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=ADC_Battery, CY_INSTANCE_SHORT_NAME=ADC_Battery, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=10, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=ADC_Battery, )
...
// Timer_v2_80(CaptureAlternatingFall=false, CaptureAlternatingRise=false, CaptureCount=2, CaptureCounterEnabled=false, CaptureInputEnabled=true, CaptureMode=3, CONTROL3=0, ControlRegRemoved=0, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG24, CySetRegReplacementString=CY_SET_REG24, DeviceFamily=PSoC5, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, HWCaptureCounterEnabled=false, InterruptOnCapture=true, InterruptOnFIFOFull=false, InterruptOnTC=false, IntOnCapture=1, IntOnFIFOFull=0, IntOnTC=0, NumberOfCaptures=1, param45=1, Period=16777215, RegDefReplacementString=reg32, RegSizeReplacementString=uint32, Resolution=24, RstStatusReplacementString=rstSts, RunMode=0, SiliconRevision=0, SoftwareCaptureModeEnabled=false, SoftwareTriggerModeEnabled=false, TriggerInputEnabled=false, TriggerMode=0, UDB16=false, UDB24=true, UDB32=false, UDB8=false, UDBControlReg=true, UsesHWEnable=0, VerilogSectionReplacementString=sT24, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=Timer_v2_80, CY_CONFIG_TITLE=Timer_IR, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Timer_IR, CY_INSTANCE_SHORT_NAME=Timer_IR, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=80, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=Timer_IR, )
...
// Timer_v2_80(CaptureAlternatingFall=false, CaptureAlternatingRise=false, CaptureCount=2, CaptureCounterEnabled=false, CaptureInputEnabled=true, CaptureMode=1, CONTROL3=0, ControlRegRemoved=0, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG16, CySetRegReplacementString=CY_SET_REG16, DeviceFamily=PSoC5, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, HWCaptureCounterEnabled=false, InterruptOnCapture=false, InterruptOnFIFOFull=false, InterruptOnTC=true, IntOnCapture=0, IntOnFIFOFull=0, IntOnTC=1, NumberOfCaptures=1, param45=1, Period=65535, RegDefReplacementString=reg16, RegSizeReplacementString=uint16, Resolution=16, RstStatusReplacementString=rstSts, RunMode=1, SiliconRevision=0, SoftwareCaptureModeEnabled=false, SoftwareTriggerModeEnabled=false, TriggerInputEnabled=false, TriggerMode=0, UDB16=true, UDB24=false, UDB32=false, UDB8=false, UDBControlReg=true, UsesHWEnable=0, VerilogSectionReplacementString=sT16, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=Timer_v2_80, CY_CONFIG_TITLE=Timer_L2, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Timer_L2, CY_INSTANCE_SHORT_NAME=Timer_L2, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=80, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=Timer_L2, )
...
// UART_v2_50(Address1=0, Address2=0, BaudRate=115200, BreakBitsRX=13, BreakBitsTX=13, BreakDetect=false, CRCoutputsEn=false, Enable_RX=1, Enable_RXIntInterrupt=0, Enable_TX=1, Enable_TXIntInterrupt=0, EnableHWAddress=0, EnIntRXInterrupt=false, EnIntTXInterrupt=false, FlowControl=0, HalfDuplexEn=false, HwTXEnSignal=true, InternalClock=true, InternalClockToleranceMinus=3.93736842105263, InternalClockTolerancePlus=3.93736842105263, InternalClockUsed=1, InterruptOnAddDetect=0, InterruptOnAddressMatch=0, InterruptOnBreak=0, InterruptOnByteRcvd=1, InterruptOnOverrunError=0, InterruptOnParityError=0, InterruptOnStopError=0, InterruptOnTXComplete=false, InterruptOnTXFifoEmpty=false, InterruptOnTXFifoFull=false, InterruptOnTXFifoNotFull=false, IntOnAddressDetect=false, IntOnAddressMatch=false, IntOnBreak=false, IntOnByteRcvd=true, IntOnOverrunError=false, IntOnParityError=false, IntOnStopError=false, NumDataBits=8, NumStopBits=1, OverSamplingRate=8, ParityType=0, ParityTypeSw=false, RequiredClock=921600, RXAddressMode=0, RXBufferSize=4, RxBuffRegSizeReplacementString=uint8, RXEnable=true, TXBitClkGenDP=true, TXBufferSize=4, TxBuffRegSizeReplacementString=uint8, TXEnable=true, Use23Polling=true, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=UART_v2_50, CY_CONFIG_TITLE=UART_2, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=UART_2, CY_INSTANCE_SHORT_NAME=UART_2, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=50, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=UART_2, )
module UART_v2_50_14 (
	...
	cy_clock_v1_0
		#(.id("d6e73d6d-77fa-486a-8a1e-bf5a49dd00cf/be0a0e37-ad17-42ca-b5a1-1a654d736358"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("1085069444.44444"),
		  .is_direct(0),
...
// Counter_v3_0(CaptureMode=0, CaptureModeSoftware=0, ClockMode=0, CompareMode=0, CompareModeSoftware=0, CompareStatusEdgeSense=true, CompareValue=0, CONTROL3=0, ControlRegRemoved=0, CyGetRegReplacementString=CY_GET_REG32, CySetRegReplacementString=CY_SET_REG32, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, InitCounterValue=0, InterruptOnCapture=false, InterruptOnCompare=false, InterruptOnOverUnderFlow=false, InterruptOnTC=false, Period=4294967294, RegDefReplacementString=reg32, RegSizeReplacementString=uint32, ReloadOnCapture=false, ReloadOnCompare=false, ReloadOnOverUnder=true, ReloadOnReset=true, Resolution=32, RunMode=0, UDB16=false, UDB24=false, UDB32=true, UDB8=false, UDBControlReg=true, UseInterrupt=true, VerilogSectionReplacementString=sC32, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=Counter_v3_0, CY_CONFIG_TITLE=StatisticsCounter, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=StatisticsCounter, CY_INSTANCE_SHORT_NAME=StatisticsCounter, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=StatisticsCounter, )
module Counter_v3_0_15 (
    reset,
    tc,
    comp,
    clock,
...
module top ;
    ...
    UART_v2_50_2 UART_1 (
        ...
        .reset(1'b0),
        .rx(Net_315),
        .tx_interrupt(Net_4187),
        .rx_interrupt(Net_4188),
        .tx_data(Net_1945),
        .tx_clk(Net_1946),
        .rx_data(Net_1947),
        .rx_clk(Net_1948));
    ...
    Timer_v2_80_3 Timer_L3 (
        .reset(Net_3817),
        .interrupt(Net_3177),
        .enable(1'b1),
        .trigger(1'b1),
        .capture(Net_4068),
        .capture_out(Net_3974),
        .tc(Net_3975),
        .clock(Net_3154));
    ...
    Timer_v2_80_4 Timer_R3 (
        .reset(Net_3817),
        .interrupt(Net_3270),
        .enable(1'b1),
        .trigger(1'b1),
        .capture(Net_4066),
        .capture_out(Net_3978),
        .tc(Net_3979),
        .clock(Net_2600));
	...
	wire [0:0] tmpOE__Refl_led_net;
	wire [0:0] tmpFB_0__Refl_led_net;
	wire [0:0] tmpIO_0__Refl_led_net;
	wire [0:0] tmpINTERRUPT_0__Refl_led_net;
	electrical [0:0] tmpSIOVREF__Refl_led_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("59fcf6b7-74f2-4a92-9fc5-c7f5d998d830"),
		  ...
		  .input_buffer_sel(2'b00))
		Refl_led
		 (.oe(tmpOE__Refl_led_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Refl_led_net[0:0]}),
		  .io({tmpIO_0__Refl_led_net[0:0]}),
		  .siovref(tmpSIOVREF__Refl_led_net),
		  .interrupt({tmpINTERRUPT_0__Refl_led_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Refl_led_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    Timer_v2_80_5 Timer_R1 (
        .reset(Net_3817),
        .interrupt(Net_2909),
        .enable(1'b1),
        .trigger(1'b1),
        .capture(Net_4067),
        .capture_out(Net_3982),
        .tc(Net_4014),
        .clock(Net_10));
    ...
    assign Net_4088 = ~Net_4089;

    Timer_v2_80_6 Timer_L1 (
        .reset(Net_3817),
        .interrupt(Net_3205),
        .enable(1'b1),
        .trigger(1'b1),
        .capture(Net_4069),
        .capture_out(Net_3986),
        .tc(Net_3987),
        .clock(Net_3163));
    ...
    assign Net_4082 = ~Net_3172;


    assign Net_4018 = Net_3848 & Net_2909 & Net_3270 & Net_3177 & Net_3205 & Net_3849;
    ...
    Timer_v2_80_10 Timer_IR (
        .reset(Net_3788),
        .interrupt(Net_3997),
        .enable(1'b1),
        .trigger(1'b1),
        .capture(Net_3800),
        .capture_out(Net_4000),
        .tc(Net_4001),
        .clock(Net_4020));
    defparam Timer_IR.CaptureCount = 2;
    defparam Timer_IR.CaptureCounterEnabled = 0;
    defparam Timer_IR.DeviceFamily = "PSoC5";
    defparam Timer_IR.InterruptOnCapture = 1;
    defparam Timer_IR.InterruptOnTC = 0;
    defparam Timer_IR.Resolution = 24;
    defparam Timer_IR.SiliconRevision = "0";
    ...
    Timer_v2_80_11 Timer_R2 (
        .reset(Net_3817),
        .interrupt(Net_3848),
        .enable(1'b1),
        .trigger(1'b1),
        .capture(Net_4038),
        .capture_out(Net_4095),
        .tc(Net_4004),
        .clock(Net_3815));
    defparam Timer_R2.CaptureCount = 2;
    defparam Timer_R2.CaptureCounterEnabled = 0;
    defparam Timer_R2.DeviceFamily = "PSoC5";
    defparam Timer_R2.InterruptOnCapture = 0;
    defparam Timer_R2.InterruptOnTC = 1;
    defparam Timer_R2.Resolution = 16;
    defparam Timer_R2.SiliconRevision = "0";

    Timer_v2_80_12 Timer_L2 (
        .reset(Net_3817),
        .interrupt(Net_3849),
        .enable(1'b1),
        .trigger(1'b1),
        .capture(Net_3834),
        .capture_out(Net_4007),
        .tc(Net_4008),
        .clock(Net_3830));
    defparam Timer_L2.CaptureCount = 2;
    defparam Timer_L2.CaptureCounterEnabled = 0;
    defparam Timer_L2.DeviceFamily = "PSoC5";
    defparam Timer_L2.InterruptOnCapture = 0;
    defparam Timer_L2.InterruptOnTC = 1;
    defparam Timer_L2.Resolution = 16;
    defparam Timer_L2.SiliconRevision = "0";
	...
	wire [0:0] tmpOE__R2_net;
	wire [0:0] tmpFB_0__R2_net;
	wire [0:0] tmpINTERRUPT_0__R2_net;
	...
	cy_psoc3_pins_v1_10
		...
		R2
		 (.oe(tmpOE__R2_net),
		  ...
		  .interrupt({tmpINTERRUPT_0__R2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__R2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};


    assign Net_4049 = ~Net_4054;


    assign Net_4045 = ~Net_3930;

	wire [0:0] tmpOE__ShieldLed_net;
	wire [0:0] tmpFB_0__ShieldLed_net;
	wire [0:0] tmpIO_0__ShieldLed_net;
	wire [0:0] tmpINTERRUPT_0__ShieldLed_net;
	electrical [0:0] tmpSIOVREF__ShieldLed_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e31c1b62-8c2d-4b3a-bde0-4ecc9ba178cf"),
		  ...
		  .input_buffer_sel(2'b00))
		ShieldLed
		 (.oe(tmpOE__ShieldLed_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__ShieldLed_net[0:0]}),
		  .io({tmpIO_0__ShieldLed_net[0:0]}),
		  .siovref(tmpSIOVREF__ShieldLed_net),
		  .interrupt({tmpINTERRUPT_0__ShieldLed_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__ShieldLed_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__Pin_A5_net;
	wire [0:0] tmpFB_0__Pin_A5_net;
	wire [0:0] tmpIO_0__Pin_A5_net;
	wire [0:0] tmpINTERRUPT_0__Pin_A5_net;
	electrical [0:0] tmpSIOVREF__Pin_A5_net;

	cy_psoc3_pins_v1_10
		#(.id("e4affa7f-0519-4677-aa1a-ecdf6cded5ee"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_A5
		 (.oe(tmpOE__Pin_A5_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_A5_net[0:0]}),
		  .io({tmpIO_0__Pin_A5_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_A5_net),
		  .interrupt({tmpINTERRUPT_0__Pin_A5_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_A5_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_A4_net;
	wire [0:0] tmpFB_0__Pin_A4_net;
	wire [0:0] tmpIO_0__Pin_A4_net;
	wire [0:0] tmpINTERRUPT_0__Pin_A4_net;
	electrical [0:0] tmpSIOVREF__Pin_A4_net;

	cy_psoc3_pins_v1_10
		#(.id("d51831d1-fc3e-4c6f-a3ee-7924d2209086"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_A4
		 (.oe(tmpOE__Pin_A4_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_A4_net[0:0]}),
		  .io({tmpIO_0__Pin_A4_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_A4_net),
		  .interrupt({tmpINTERRUPT_0__Pin_A4_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_A4_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    // -- SRFF Start --
    reg  cy_srff_1;
    always @(posedge Net_3815)
    begin
        cy_srff_1 <= (Net_4045 | Net_4038) & ~Net_3817;
    end
    assign Net_4038 = cy_srff_1;
    // -- SRFF End --

    // -- SRFF Start --
    reg  cy_srff_2;
    always @(posedge Net_3830)
    begin
        cy_srff_2 <= (Net_4049 | Net_3834) & ~Net_3817;
    end
    assign Net_3834 = cy_srff_2;
    // -- SRFF End --

    // -- SRFF Start --
    reg  cy_srff_3;
    always @(posedge Net_10)
    begin
        cy_srff_3 <= (Net_4070 | Net_4067) & ~Net_3817;
    end
    assign Net_4067 = cy_srff_3;
    // -- SRFF End --

    // -- SRFF Start --
    reg  cy_srff_4;
    always @(posedge Net_2600)
    begin
        cy_srff_4 <= (Net_4088 | Net_4066) & ~Net_3817;
    end
    assign Net_4066 = cy_srff_4;
    // -- SRFF End --

    // -- SRFF Start --
    reg  cy_srff_5;
    always @(posedge Net_3154)
    begin
        cy_srff_5 <= (Net_4078 | Net_4068) & ~Net_3817;
    end
    assign Net_4068 = cy_srff_5;
    // -- SRFF End --

    // -- SRFF Start --
    reg  cy_srff_6;
    always @(posedge Net_3163)
    begin
        cy_srff_6 <= (Net_4082 | Net_4069) & ~Net_3817;
    end
    assign Net_4069 = cy_srff_6;
    // -- SRFF End --
    ...
    UART_v2_50_14 UART_2 (
        ...
        .reset(1'b0),
        .rx(Net_4102),
        .tx_interrupt(Net_4131),
        .rx_interrupt(Net_4132),
        .tx_data(Net_4127),
        .tx_clk(Net_4128),
        .rx_data(Net_4129),
        .rx_clk(Net_4130));
	...
	wire [0:0] tmpOE__RX_E_net;
	wire [0:0] tmpIO_0__RX_E_net;
	wire [0:0] tmpINTERRUPT_0__RX_E_net;
	electrical [0:0] tmpSIOVREF__RX_E_net;

	cy_psoc3_pins_v1_10
		#(.id("30d95b7a-e53e-40ea-afec-237357e734ed"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		RX_E
		 (.oe(tmpOE__RX_E_net),
		  .y({1'b0}),
		  .fb({Net_4102}),
		  .io({tmpIO_0__RX_E_net[0:0]}),
		  .siovref(tmpSIOVREF__RX_E_net),
		  .interrupt({tmpINTERRUPT_0__RX_E_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__RX_E_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__TX_E_net;
	wire [0:0] tmpFB_0__TX_E_net;
	wire [0:0] tmpIO_0__TX_E_net;
	wire [0:0] tmpINTERRUPT_0__TX_E_net;
	electrical [0:0] tmpSIOVREF__TX_E_net;

	cy_psoc3_pins_v1_10
		#(.id("b70f6388-00b4-482a-92bc-89b706bec690"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		TX_E
		 (.oe(tmpOE__TX_E_net),
		  .y({Net_4097}),
		  .fb({tmpFB_0__TX_E_net[0:0]}),
		  .io({tmpIO_0__TX_E_net[0:0]}),
		  .siovref(tmpSIOVREF__TX_E_net),
		  .interrupt({tmpINTERRUPT_0__TX_E_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__TX_E_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    assign Net_4165 = 1'h0;


	cy_clock_v1_0
		#(.id("f190caba-2715-4b5d-81ec-eefb752d6b3b"),
		  .source_clock_id("75C2148C-3656-4d8a-846D-0CAE99AB6FF7"),
		  .divisor(0),
		  .period("0"),
		  .is_direct(1),
    ...
    Counter_v3_0_15 StatisticsCounter (
        .reset(Net_4165),
        .tc(Net_4166),
        .comp(Net_4167),
        .clock(Net_4180),
        ...
        .up_ndown(1'b1),
        .count(Net_4186));
    defparam StatisticsCounter.CaptureMode = 0;
    defparam StatisticsCounter.ClockMode = 0;
    defparam StatisticsCounter.CompareMode = 0;
    defparam StatisticsCounter.CompareStatusEdgeSense = 1;
    defparam StatisticsCounter.EnableMode = 0;
    defparam StatisticsCounter.ReloadOnCapture = 0;
    defparam StatisticsCounter.ReloadOnCompare = 0;
    defparam StatisticsCounter.ReloadOnOverUnder = 1;
    defparam StatisticsCounter.ReloadOnReset = 1;
    defparam StatisticsCounter.Resolution = 32;
    defparam StatisticsCounter.RunMode = 0;
    defparam StatisticsCounter.UseInterrupt = 1;
	...
	wire [0:0] tmpOE__RST_E_net;
	wire [0:0] tmpFB_0__RST_E_net;
	wire [0:0] tmpIO_0__RST_E_net;
	wire [0:0] tmpINTERRUPT_0__RST_E_net;
	electrical [0:0] tmpSIOVREF__RST_E_net;

	cy_psoc3_pins_v1_10
		#(.id("ee9b9f9c-6bb0-4536-abd0-b93bd86c619a"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		RST_E
		 (.oe(tmpOE__RST_E_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__RST_E_net[0:0]}),
		  .io({tmpIO_0__RST_E_net[0:0]}),
		  .siovref(tmpSIOVREF__RST_E_net),
		  .interrupt({tmpINTERRUPT_0__RST_E_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__RST_E_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
